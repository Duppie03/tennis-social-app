document.addEventListener('DOMContentLoaded', () => {
    ...
    function validateEndGameForm(){const e=null!=document.querySelector('input[name="winner"]:checked'),t=team1ScoreInput.value,a=team2ScoreInput.value,l=""!==t&&!isNaN(t),n=""!==a&&!isNaN(n);let s=!0;tieBreakerArea.classList.contains("hidden")||(s=""!==team1TiebreakInput.value&&!isNaN(team1TiebreakInput.value)&&""!==team2TiebreakInput.value&&!isNaN(team2TiebreakInput.value)),endGameConfirmBtn.disabled=!(e&&l&&n&&s)}
